...
export const REGLAS_CATALOGO: ReglaCatalogo[] = [
  ...
  },
  {
    ...
    descripcion:
      'El agente consulta su servicio del mes. Cada día trabajado muestra su puesto. Al pulsar un día ve los mínimos y quién trabaja en cada puesto. Cada turno (M, T y N) tiene su semáforo: verde con 2 o más agentes por encima del mínimo de ese turno, ámbar con 1 y rojo si está justo o falta gente.',
    estado: 'implementada',
    detalle:
  ...
  },
  {
    ...
    estado: 'implementada',
    detalle:
      'Lo consulta toda la plantilla con usuario. En esa vista el puesto se lee, sin desplegable. Solo jefes de servicio, responsables, admin y superadmin lo cambian. No cambia el turno y respeta los puestos desactivados en la ficha. Cuadrante jefes y calendario jefes quedan fuera de policía, jefe de equipo y bolsa; el calendario de eventos lo ven en consulta.',
  ...
  },
  {
    ...
    estado: 'implementada',
    detalle:
      'El generador reparte el descanso sobrante en huecos distintos según el agente y mueve jornadas de días saturados a días cortos, respetando fatiga, descansos de 2+ y salida de noche. Además equilibra por separado las columnas M, T y N de cada día entre agentes del mismo turno mensual. Tras construir las filas aplica varias pasadas de refinado (cobertura, mínimos operativos del día, variables de cobro y findes) y un refinado final coordinado que solo acepta movimientos que mejoran la puntuación global (mínimos → nf → NF festivos/conciliaciones).',
    referencia:
      'generarCuadranteMensual · refinarCuadranteSudoku · metricasRefinadoCuadrante',
  },
  {
    id: 'findes-mes-max',
    categoria: 'CUADRANTE',
  ...
  },
  {
    ...
    descripcion:
      'Cada jornada de mañana (M) en sábado genera una unidad de conciliación sábado mañana. El turno M-T de jefes cuenta también esta conciliación.',
    estado: 'implementada',
    referencia: 'variablesCobro · ListadosPage',
  },
  {
    ...
    descripcion:
      'Cada jornada de tarde (T) en sábado genera una unidad de conciliación sábado tarde. El turno M-T de jefes cuenta también esta conciliación.',
    estado: 'implementada',
    referencia: 'variablesCobro · ListadosPage',
  },
  {
  ...
  },
  {
    ...
    descripcion:
      'Las conciliaciones de finde y el festivo se suman: un sábado festivo con turno M genera conciliación sábado mañana y un festivo; con turno T, conciliación sábado tarde y un festivo; con turno M-T, conciliación sábado mañana, conciliación sábado tarde y dos festivos.',
    estado: 'implementada',
  ...
  },
  {
    ...
    descripcion:
      'Tras generar el cuadrante mensual, se reparten conciliaciones y festivos entre agentes del mismo turno (M/T/N del plan anual), intercambiando días de trabajo sin cambiar jornadas ni romper reglas de fatiga. El sumatorio F (festivos + conciliaciones) queda equilibrado entre compañeros del mismo turno.',
    estado: 'implementada',
    detalle:

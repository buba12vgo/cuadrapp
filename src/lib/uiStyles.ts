...
export const TOOLBAR_DIVIDER = 'mx-0.5 h-5 w-px shrink-0 bg-slate-200'
...
export const BTN_SECONDARY = `${BTN_BASE} border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 ${FOCUS_RING}`

export const BTN_GHOST = `${BTN_BASE} text-slate-600 hover:bg-slate-100 ${FOCUS_RING}`

export const BTN_DANGER = `${BTN_BASE} border border-red-200 bg-white text-red-700 hover:bg-red-50 ${FOCUS_RING}`
